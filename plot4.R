...
plot(sub_data$datetime,as.numeric(sub_data$Voltage),type="l",ylab = "Voltage",xlab="datetime")
...
plot(sub_data$datetime,as.numeric(sub_data$Global_reactive_power),type="l",ylab = "Global_reactive_power",xlab="")
dev.off()
